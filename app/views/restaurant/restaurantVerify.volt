...
<div id="verifyRestaurantBody" class="modal-body">
    ...
    <table align="center">
        ...
        <tr>
            <td><button class="btn btn-default" onclick="verifyExecute({{ local.restaurant_id }}, false)">{{ local.restaurant_name }}</button></td>
            <td>&nbsp; or &nbsp;</td>
            <td><button class="btn btn-default" onclick="verifyExecute({{ cookie.restaurant_id }}, true)">{{ cookie.restaurant_name }}</button></td>
        </tr>
    </table><br />
